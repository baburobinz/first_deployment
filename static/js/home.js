...
// show booking details when click on booking
...
// cancel booking using cancel button
...
// close profile submenu window when click on close icon
...
// var payment_window = document.getElementsByClassName('online_payment_window');



// const check_box = document.getElementById('online_payment_check');

// check_box.addEventListener('click',function(){

//   if(payment_window[0].style.display=='block'){

//     payment_window[0].style.display='none';
...
//     payment_window[0].style.display='block';
//   }
    ...
    $.ajax({
      ...
      success: function(request){
        ...
        if (msg){
          ...
          $('.send_button').append('SENT');
          $('.send_button').append('  ');
          $('.send_button').append('<i class="fa fa-check" aria-hidden="true"></i>');
          ...
          $('.send_button').append('  ');
          $('.send_button').append('<i class="fa fa-paper-plane-o" aria-hidden="true"></i>');
          },1000);
...
function onChange() {
  const pword = document.querySelector('input[name=new_password]');
