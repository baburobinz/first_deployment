...
var feedback_container = document.getElementsByClassName('feedback_container');
...
function select(n){
    ...
    if (n===1){
       ...
       if (nav_item[n].style.background==="rgb(0, 204, 204)"){
        ...
        feedback_container[0].style.display="flex";
...
$(document).ready(function() {
    ...
    // // call updateNotification funtion at every 3 seconds
...
$(document).ready(function(){
    ...
    setInterval(check_notification_count,3000);
...
$(document).ready(function(){
    ...
    $('#feedback_clearall').click(function(){

        $(this).css({'background':'white','color':'black'})

        $('.feedback_confirm_clear_all').css('display','flex');
        $('.feedback_no').click(function(){

            $('.feedback_confirm_clear_all').hide();
            $('#feedback_clearall').css({'background':'rgb(200, 16, 16,0.7)','color':'white'});
    ...
    $('.feedback-window').on('click','.feedback_close',function(){
    ...
    function get_feedbacks(){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                var data_received = data.feedbacks;
               ...
               if (data_received.length>0){
                ...
                $('.feedback-window').empty()
               


               data_received.forEach(function(item){

                var feedback_div = $('<div>').attr('class','feedback');

                var name_head = $('<h3>').attr('class','name').text(item.name);

                var para = $('<p>').text(item.feed)

                var msg_div = $('<div>').attr('class','message').append(para);

                var close_icon = $('<img>').attr('src','static/icons/close_notification_red.png').attr('class','feedback_close').attr('data-value', item.id);
                
                var user_icon = $('<img>').attr('src','static/icons/user_icon.png').attr('class','usericon')
                
                feedback_div.append(user_icon);
                feedback_div.append(name_head);
                feedback_div.append(msg_div);
                feedback_div.append(close_icon);

                $('.feedback-window').append(feedback_div)
