        ...
        try:
            ...
            if data:
                ...
                if user_name==data.Username and checkpassword == True:
                    ...
                    return JsonResponse({'message':invalid_msg},safe=False)
        except:
...
def profile(request):
    ...
    if 'id' in request.session:
        ...
        return render(request, 'home.html',{'todays_offer':todays_offer,'haircut_price':haircut_price,'massage_price':massage_price,'makeup_price':makeup_price,'gallery_images_display':gallery_images_display,'username':username})
...
def submit_feedback(request):
    ...
    if request.method=='POST':
        ...
        data = feedback.objects.create(Name=n,Message=m)

        data.save()

        return JsonResponse({'message':'Feedback successfully sent'})
...
def get_feedbacks(request):
    ...
    if request.method=='GET':
        ...
        get_data = feedback.objects.all().values()
...
def delete_all_feedbacks(request):
...
def delete_single_feedback(request,id):
